...
class TestGetBirthdaysPerWeek(unittest.TestCase):
    ...
    def test_all_past_birthdays_this_year(self, date_mock):
        """
Успішно пройдено тест коли всі дні народження користувачів вже минули у цьому році
        """
    ...
    def test_empty_users(self, date_mock):
        """
Успішно пройдено тест коли у функцію передали пустий список користувачів
        """
        date_mock.today.return_value = self.today.date()
        users = []
        result = get_birthdays_per_week(users)
    ...
    def test_weekend_birthdays(self, date_mock):
        """
Успішно пройдено тест коли функція повернула правильний список днів народження користувачів, причому деякі припадають на вихідні
        """
        date_mock.today.return_value = self.today.date()
        users = [
            {
    ...
    def test_past_birthdays_next_week(self, date_mock):
        """
Успішно пройдено тест коли функція повернула правильний список днів народження користувачів, де деякі дні народження вже минули в цьому році, але вони будуть на наступному тижні
        """
        date_mock.today.return_value = self.today.date()
        users = [
            {
    ...
    def test_future_birthdays(self, date_mock):
        """
Успішно пройдено тест коли функція повернула правильний список днів народження користувачів які не припадають на вихідні
        """
        date_mock.today.return_value = self.today.date()
        users = [
            {
